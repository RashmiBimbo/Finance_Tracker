...
{
    public partial class Performance_V2 : Page
    {
        ...
        private readonly DateTime lstMnth = new DateTime(DateTime.Today.Year, DateTime.Today.Month, 1);
        private readonly DateTime lstDay = new DateTime(DateTime.Today.Year, DateTime.Today.Month, 1).AddMonths(-1);
        ...
        private void ResetTab1()
        {
            ...
            CalendarExtender1.EndDate = new DateTime(Today.Year, Today.Month, DaysInMonth(Today.Year, Today.Month));
        ...
        private bool AddTaskToDB(string proc, string fullPath, string rec_Id = "")
        {
            ...
            OleDbParameter[] paramCln = new OleDbParameter[]
            {
                ...
                new OleDbParameter("@Submit_Date", Now.Date.ToString(SqlDateFormat)),
